...
//		contentPane.setBackground(new Color(15, 17, 26));
		...
		String[] options = {"Upload File", "Restart", "Exit"};
		JComboBox <String> comboBoxFile = new JComboBox<>(options);
		
		
//		comboBoxFile.setModel(new DefaultComboBoxModel<String>(new String[] {"File", "Upload File"}));
		GridBagConstraints gbc_comboBoxFile = new GridBagConstraints();
		gbc_comboBoxFile.anchor = GridBagConstraints.WEST;
		gbc_comboBoxFile.insets = new Insets(0, 0, 5, 5);
		gbc_comboBoxFile.gridx = 0;
		gbc_comboBoxFile.gridy = 0;
		contentPane.add(comboBoxFile, gbc_comboBoxFile);
...
//		lblPageHeader.setForeground(new Color(140, 180, 255));
		...
		//        btnBlastInterface.setForeground(new Color(60, 210, 140));
				...
				gbc_btnBlastInterface.insets = new Insets(0, 0, 5, 0);
				gbc_btnBlastInterface.fill = GridBagConstraints.BOTH;
				gbc_btnBlastInterface.gridx = 2;
